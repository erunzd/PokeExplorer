  ...
  return (
    <View style={styles.header}>
        <View style={styles.titleWrapper}>
            <Text style={[styles.titleOutline, { top: 3, left: 0 }]}>Trainer Card</Text>
            <Text style={[styles.titleOutline, { top: -3, left: 0 }]}>Trainer Card</Text>
            <Text style={[styles.titleOutline, { top: 0, left: 3 }]}>Trainer Card</Text>
            <Text style={[styles.titleOutline, { top: 0, left: -3 }]}>Trainer Card</Text>

            <Text style={styles.title}>Trainer Card</Text>
        </View>
